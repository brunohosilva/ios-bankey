...
//  Bankey
//
//  Created by Bruno Oliveira on 12/12/23.
//
...
extension AccountSummaryCell{
    ...
    private func setup() {
        ...
        balanceAmountLabel.attributedText = makeFormattedBalance(money: "XXX,XXX", cents: "XX")
    ...
    private func layout() {
        NSLayoutConstraint.activate([
            ...
            nameLabel.leadingAnchor.constraint(lessThanOrEqualToSystemSpacingAfter: leadingAnchor, multiplier: 2),
