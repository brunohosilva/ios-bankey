...
class AccountSummaryViewControllerTests: XCTestCase {
    ...
    func testTitleAndMessageForServerError() throws {
        ...
        XCTAssertEqual("Ensure you are conected to the internet. Please try gain", titleAndMessage.1)
    }
    ...
    func testAlertForServerError() throws {
        ...
        XCTAssertEqual("Ensure you are conected to the internet. Please try gain", vc.errorAlert.message)
    }
